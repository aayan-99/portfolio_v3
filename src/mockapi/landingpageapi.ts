...
export const photoCardData = {
    ...
    githubAcc: 'https://github.com/aayan-99',
    linkedinAcc: 'https://linkedin.com/in/aayanjit-bhuyan-b48705195/',
    instagramAcc: 'https://www.instagram.com/____a__y__n____?igshid=OGQ5ZDc2ODk2ZA==',
};
